...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/static/notcommon/User_Data_Update/User_Data_Update/css/jiazaitoubu.css"
	type="text/css" />
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/static/notcommon/User_Data_Update/User_Data_Update/css/css.css"
	type="text/css" />
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/static/notcommon/User_Data_Update/User_Data_Update/css/center.css"
	type="text/css" />
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/static/notcommon/User_Data_Update/User_Data_Update/city/city.css"
	type="text/css" />

<!-- <script src="<%=request.getContextPath()%>/static/User_Data_Update/"></script> -->
<script
	src="<%=request.getContextPath()%>/static/notcommon/User_Data_Update/User_Data_Update/js/jquery-1.8.3.min.js"></script>
<script
	src="<%=request.getContextPath()%>/static/notcommon/User_Data_Update/User_Data_Update/js/index2.js"></script>
<script
	src="<%=request.getContextPath()%>/static/notcommon/User_Data_Update/User_Data_Update/js/index2.js"></script>
		...
		<div class="centers_ml">
			...
			<div class="centers_listm">
				<div class="centers_listm_one">
					<img
						src="<%=request.getContextPath()%>/static/notcommon/User_Data_Update/User_Data_Update/images/zshy.png" />
					<em>会员中心</em>
				</div>
				<!--一条开始-->
				<div class="centers_listm_one_in">
					<img
						src="<%=request.getContextPath()%>/static/notcommon/User_Data_Update/User_Data_Update/images/shezhi.png" />
					<em>资料管理</em> <b></b>
				</div>
