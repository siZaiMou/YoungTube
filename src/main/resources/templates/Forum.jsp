...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/notcommon/Forum/Forum/css/style_4_common.css"/>
    <link rel="stylesheet" type="text/css"
          href="<%=request.getContextPath()%>/static/notcommon/Forum/Forum/css/style_4_forum_forumdisplay.css"/>

    <script src="<%=request.getContextPath()%>/static/notcommon/Forum/Forum/js/common.js" type="text/javascript"></script>
    <link rel="stylesheet" id="css_widthauto" type="text/css"
          href="<%=request.getContextPath()%>/static/notcommon/Forum/Forum/css/style_4_widthauto.css"/>
    <script type="text/javascript">
        HTMLNODE.className += ' widthauto'
    </script>
    <script src="<%=request.getContextPath()%>/static/notcommon/Forum/Forum/js/forum.js" type="text/javascript"></script>
    <script
            src="<%=request.getContextPath()%>/static/notcommon/Homepage/Homepage/js/jquery.min.js"></script>
        ...
        <div class="hdc cl margin-top-bottom">
            <div class="login-container" align="center">
                <div class="well well-small pull-right user-panel-mini">
                    <script src="<%=request.getContextPath()%>/static/notcommon/Forum/Forum/js/logging.js"
                        ...
                        <c:forEach items="${list}" var="list">
                            ...
                            <tr>
                                <td class="icn"><a href="forumReply.sf?forumID=${list.forumID}" title="有新回复 - 新窗口打开"
                                                   target="_blank"> <img
                                        src="<%=request.getContextPath()%>/static/notcommon/Forum/Forum/picture/folder_new.gif"/>
                                </a></td>
                        ...
                        <div class="cl">
                            ...
                            <div class="hasfsl" id="fastposteditor">
                                <div class="tedt">
                                    <div class="bar">
                                        <span class="y"> </span>
                                        <script src="<%=request.getContextPath()%>/static/notcommon/Forum/Forum/js/seditor.js"
                                                type="text/javascript"></script>
                                        <div class="fpd">
...
<script src="<%=request.getContextPath()%>/static/notcommon/Forum/Forum/js/home.js" type="text/javascript"></script>
<div id="scrolltop">
